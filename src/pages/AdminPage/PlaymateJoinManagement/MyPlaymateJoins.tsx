...
const MyPlaymateJoins: React.FC = () => {
  ...
  const { data, isLoading, isError } = useGetMyPlaymateJoinsQuery(undefined);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-8">
      <div className="mb-6 bg-white rounded-xl shadow-sm p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h2 className="text-3xl font-bold text-gray-800 mb-1">My Playmate Joins</h2>
            <p className="text-gray-500 text-sm">View your playmate joins</p>
          </div>
        </div>
      </div>
