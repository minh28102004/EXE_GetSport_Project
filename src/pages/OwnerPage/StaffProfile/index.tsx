        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-lg font-semibold">Trần Thị B</h2>
                <p className="text-gray-500">Nhân viên lễ tân</p>
              </div>
            </div>
            ...
            <form className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                ...
                <input
                  type="text"
                  className="w-full border rounded-md px-3 py-2"
                  value="789 Đường GHI, Quận LMN, TP.HCM"
                />
              </div>
              ...
              <div className="col-span-2">
                ...
                <textarea
                  className="w-full border rounded-md px-3 py-2"
                  rows={3}
                  defaultValue="Nhân viên lễ tân với 2 năm kinh nghiệm hỗ trợ khách hàng và quản lý đặt sân."
                />
              </div>
            </form>
